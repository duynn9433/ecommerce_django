...
urlpatterns = [
    path('register/', views.register, {'template_name': 'registration/register.html'}, name='register'),
    ...
    path('login/', django.contrib.auth.views.LoginView.as_view(template_name='registration/login.html'),
         {'template_name': 'registration/login.html', 'SSL': settings.ENABLE_SSL}, name='login'),
